...
var NumbersCollection = /** @class */ (function (_super) {
    ...
    NumbersCollection.prototype.compare = function (firstIteretionIndex, secondIterationIndex) {
        return this.data[firstIteretionIndex] > this.data[secondIterationIndex];
    };
    NumbersCollection.prototype.swap = function (firstIteretionIndex, secondIterationIndex) {
        var temp = this.data[secondIterationIndex];
