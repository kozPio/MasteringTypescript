...
var Model = function () {
  function Model(atributes, events, sync) {
    this.atributes = atributes;
    this.events = events;
    this.sync = sync;
    this.on = this.events.on;
    this.trigger = this.events.trigger;
    this.get = this.atributes.get;
  }
  ...
  Model.prototype.save = function () {
    ...
    this.sync.save(this.atributes.getAll()).then(function (response) {
      _this.trigger('save');
    }).catch(function () {
      _this.trigger('error');
    });
...
exports.Model = Model;
},{}],"src/models/Atributes.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Atributes = void 0;

var Atributes = function () {
  function Atributes(data) {
    var _this = this;
  ...
  Atributes.prototype.set = function (update) {
    Object.assign(this.data, update);
  };

  Atributes.prototype.getAll = function () {
    return this.data;
  };
...
},{"./utils":"node_modules/axios/lib/utils.js","./helpers/normalizeHeaderName":"node_modules/axios/lib/helpers/normalizeHeaderName.js","./adapters/xhr":"node_modules/axios/lib/adapters/xhr.js","./adapters/http":"node_modules/axios/lib/adapters/xhr.js","process":"C:/Users/pitrx/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/axios/lib/core/dispatchRequest.js":[function(require,module,exports) {
'use strict';
...
var Collection = function () {
  function Collection(rootUrl, desirialize) {
    this.rootUrl = rootUrl;
    this.desirialize = desirialize;
    this.models = [];
  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.rootUrl).then(function (response) {
      response.data.forEach(function (value) {
        _this.models.push(_this.desirialize(value));
      });
...
var Atributes_1 = require("./Atributes");
...
var User = function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Atributes_1.Atributes(attrs), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(rootUrl));
  };
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Atributes":"src/models/Atributes.ts","./ApiSync":"src/models/ApiSync.ts","./Eventing":"src/models/Eventing.ts","./Collection":"src/models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
userForm.render(); // const user = new User({name: 'John', age: 20});
...
// });
// user.trigger('asd');
},{"./views/UserForm":"src/views/UserForm.ts","./models/User":"src/models/User.ts"}],"C:/Users/pitrx/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/pitrx/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
