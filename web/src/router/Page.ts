import {RequiredKeys, PageProps, Equals} from './types';
...
type ExtractedVariables =
  TemplateVariables<'posts/:postId/comments/:commentId'>

type InvalidTemplate =
  TemplateVariables<':projectId/workers/prefixes_not_allowed:workerId/:docId/:x'>

type MoreExtractedVariables =
  TemplateVariables<':projectId/workers/:workerId/:docId/:x'>
